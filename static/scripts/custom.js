...
$(document).ready(function () {
  ...
  function init_template() {
    ...
    menuDeployer.on("click", function () {
      ...
      function menuActivate() {
        menuID = "menu-active"
          ...
          : menuID.removeClass("menu-active");
      }
      ...
      if (menuEffect === "menu-parallax") {
        if (menuID.hasClass("menu-box-bottom")) {
          headerAndContent.css(
            "transform",
            "translateY(" + (menuHeight / 5) * -1 + "px)"
          );
        }
        ...
        if (menuID.hasClass("menu-box-left")) {
          headerAndContent.css(
            "transform",
            "translateX(" + menuWidth / 5 + "px)"
          );
        }
        if (menuID.hasClass("menu-box-right")) {
          headerAndContent.css(
            "transform",
            "translateX(" + (menuWidth / 5) * -1 + "px)"
          );
        }
      }
    ...
    $("[data-toggle-theme], [data-toggle-theme-switch]").on(
      "click",
      function () {
        removeTransitions();
    ...
    function setColorScheme() {
      ...
      window
        ...
        .addListener((e) => e.matches && activateNoPreference());
    ...
    if ($(".footer-bar-2, .footer-bar-4, .footer-bar-5").length) {
      if (
        ...
        $(
          ".footer-bar-2 .active-nav, .footer-bar-4 .active-nav, .footer-bar-5 .active-nav"
    ...
    localStorage.setItem(
      "z_Sticky-Visited:" + window.location.pathname,
      "Page Visited"
    );
      ...
      $(this).each(function (index, element) {
        if (
          (element.host == window.location.host &&
            localStorage.getItem("z_Sticky-Visited:" + element.pathname)) ||
          localStorage.getItem("z_Sticky-Visited:" + element.pathname + "/")
        ) {
          if (className) {
    ...
    function search_menu() {
      $("[data-search]").on("keyup", function () {
        ...
        if (searchVal != "") {
          ...
          $(
            '[data-filter-item][data-filter-name*="' +
              ...
              '"]'
          ).removeClass("disabled-search-item");
        } else {
          $(".search-header a").removeClass("disabled");
        ...
        var search_results_active = $(".search-results").find(
          ".search-result-list.disabled-search-item"
        );
    ...
    setTimeout(function () {
      ...
      $(".next-slide, .next-slide-arrow, .next-slide-text, .cover-next").on(
        "click",
        function () {
          $(this).parent().find(".owl-carousel").trigger("next.owl.carousel");
        }
      );
      $(".prev-slide, .prev-slide-arrow, .prev-slide-text, .cover-prev").on(
        "click",
        function () {
    ...
    */
    ...
    function activate_business_hours() {
      if (businessHours.length) {
        ...
        var closedMessageUnder = businessHours
          .data("closed-message-under")
          .toString();
        var openedMessage = businessHours.data("opened-message").toString();
        var openedMessageUnder = businessHours
          .data("opened-message-under")
          .toString();
    ...
    $(".simulate-android-badge").on("click", function () {
      $(".add-to-home")
        .removeClass("add-to-home-ios")
        .addClass("add-to-home-visible add-to-home-android");
    });
    $(".simulate-iphone-badge").on("click", function () {
      $(".add-to-home")
        .removeClass("add-to-home-android")
        .addClass("add-to-home-visible add-to-home-ios");
    });
      ...
      $("[data-card-height]").each(function () {
        ...
        if (cardHeight == "cover") {
          if (header.length && menuFooter.length) {
            ...
            $(".map-full, .map-full iframe").css(
              "height",
              windowHeight - headerHeight - footerHeight + 14
            );
          } else {
    ...
    $(".card-hide")
      ...
      .bind("mouseenter mouseleave touchstart touchend", function () {
        $(this)
          .find(".card-center, .card-bottom, .card-top, .card-overlay")
          .toggleClass("card-hide-image");
      });
    ...
    $(".caption-hide")
      ...
      .bind("mouseenter mouseleave touchstart touchend", function () {
        $(this)
          ...
          .toggleClass("caption-hide-image");
      });
    ...
    function activate_todo_list() {
      ...
      $(".todo-list a").on("click", function () {
        $(this)
          .find(".todo-icon")
          .toggleClass("far fa-square fa fa-check-square color-green1-dark");
        if ($(this).find(".todo-icon").hasClass("far fa-square")) {
          $(this).removeClass("opacity-70");
        } else {
          $(this).addClass("opacity-70");
        ...
        function success(position) {
          ...
          $(".location-map")
            ...
            .after(
              " <a href=" +
                mapLinkAddress +
                ' class="btn btn-full btn-m bg-red2-dark rounded-xs text-uppercase font-900 mb-n1 mt-3">View on Google Maps</a>'
            );
        }
        function error() {
    ...
    if (!offlineAlerts.length) {
      $("body").append(
        '<p class="offline-message bg-red2-dark color-white center-text uppercase ultrabold">No internet connection detected</p> '
      );
      $("body").append(
        '<p class="online-message bg-green1-dark color-white center-text uppercase ultrabold">You are back online</p>'
      );
    }
    ...
    function highlight_colors() {
      ...
      if (data.indexOf(bodyColor) > -1) {
        ...
        var backgroundColorCode =
          colorsArray[backgroundLocated][3] +
          ", " +
          colorsArray[backgroundLocated][1];
        var highlightColor =
          ".color-highlight{color:" + highlightColorCode + "!important}";
        var highlightBg =
          ".bg-highlight, .page-item.active a{background-color:" +
          highlightColorCode +
          "!important}";
        var highlightNav =
          ".footer-bar-1 .active-nav *, .footer-bar-3 .active-nav i{color:" +
          highlightColorCode +
          "!important} .footer-bar-2 strong, .footer-bar-4 strong, .footer-bar-5 strong{background-color:" +
          highlightColorCode +
          "!important; color:#FFF;}";
        var highlightBorder =
          ".border-highlight{border-color:" +
          highlightColorCode +
          "!important}";
        var highlightHeaderTabs =
          ".header-tab-active{border-color:" +
          highlightColorCode +
          "!important}";
        var bodyBG =
          "#page{background: linear-gradient(0deg, " +
          backgroundColorCode +
          ")!important;} .bg-page{background: linear-gradient(0deg, " +
          backgroundColorCode +
          ")!important }";
  ...
  */
  ...
  if (isDevelopment === true) {
    if (!$(".reloader").length) {
      $("body").append(
        '<a href="#" class="reloader" style="position:fixed; background-color:#000; color:#FFF; z-index:9999; bottom:80px; left:50%; margin-left:-105px; border-radius:10px; width:210px; line-height:40px; text-align:center;">Developer Mode - Tap to Reload</a>'
      );
    }
  ...
  if (isPWA === true) {
    ...
    function loadPWA() {}
    loadJS("/css/scripts/pwa.js", loadPWA, document.body);
  }
  */
});
